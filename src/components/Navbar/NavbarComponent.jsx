...
const NavbarComponent = () => {
   ...
   // Function to open/close the navbar in small screens
   const toggleNavbar = () => {
   ...
   return (
      <header className="container-fluid py-4 shadow-sm">
         <div className="container d-flex justify-content-between">
            ...
            <button onClick={toggleNavbar} className="btn d-lg-none fs-2"><i className="bi bi-list"></i></button>
            ...
            <nav className={`d-flex align-items-center gap-5 nav-small-screen rounded-0 ${isNavbarOpen ? "show" : ""}`}>
               <div className="position-absolute d-lg-none top-0 d-flex justify-content-end w-100 mt-3 me-5">
                  <button onClick={toggleNavbar} className="btn text-white fs-2"><i className="bi bi-x-lg"></i></button>
               </div>
